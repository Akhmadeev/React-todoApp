    ...
    return (
      <header className="header">
        ...
        <form  onSubmit={this.onSubmit}  className='new-todo-form' >
          ...
          <input className="new-todo-form__timer"  required placeholder="Min"
            onChange={this.onMinutsChange} type='number' min={0} max={60}/>
          <input className="new-todo-form__timer" required placeholder="Sec"
            onChange={this.onSexondsChange} type='number' min={0} max={60} />
        </form>
    </header>
    )
  }
